...
header("Content-type: text/html;charset=utf-8");
  ...
  <?php  echo '<h2>'.$row[sp_name].'</h2>'?>
  <hr>
      
      <?php echo "<img class=\"am-thumbnail pic-image am-img-responsive\" src=\"".$row[tp_path]."\">"; ?>
      <hr>
<form  method="post" action="dd.php">
  <div class="am-g">
      ...
      <div class="am-u-sm-10">
         <?php  echo "<input name=\"sp_name\"  value=\"".$row[sp_name]."\">"  ?>
      </div>
  </div>  <hr>
  <div class="am-g">
      <div class="am-u-sm-2">
      ...
      <div class="am-u-sm-10">
      <?php  echo "<input name=\"jiage\"  value=\"".$row[jiage]."\">"  ?>
      </div>
  </div>  <hr>
...
<?php
    ...
    while($row = mysql_fetch_array($result)){
        ...
        echo "地址 ：<option value=\"".$row[dizhi]."\">".$row[dizhi]."</option>";
    }
?>
  ...
  <hr>
  <label><input type="checkbox" name="use_q">使用优惠券</label>
  <hr>
